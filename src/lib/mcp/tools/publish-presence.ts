...
export default defineTool({
  ...
  outputSchema: {
    published: z.boolean().optional().describe("True when the Presence is live."),
    updated: z.boolean().optional().describe("True when an already live Presence was rewritten."),
    publish_requires_payment: z.boolean().optional().describe("True when a paid subscription is still missing."),
    payment_completed: z.boolean().optional(),
    mode: z.string().optional().describe("live or test."),
    status: z.string().optional(),
    plan: z.string().optional().describe("plus, pro or business."),
    slug: z.string().optional().describe("Public Presence slug."),
    version: z.number().optional(),
    presence_url: z.string().optional().describe("Public Presence URL."),
    files: z.array(z.string()).optional().describe("Absolute URLs of the published AI-readable files."),
    published_at: z.string().optional(),
    updated_at: z.string().optional(),
    presence_score: z.number().optional(),
    recovery_code: z.string().nullable().optional().describe("One-time management secret — shown once, never re-issued. Display verbatim."),
    recovery_code_note: z.string().optional(),
    manage_url: z.string().optional(),
    already_published_slug: z.string().nullable().optional(),
    reason: z.string().optional(),
    handoff_url: z.string().optional().describe("Website checkout/publish link carrying the anonymous draft."),
    handoff_note: z.string().optional(),
    pricing_url: z.string().optional(),
    suggested_slug: z.string().optional(),
    remaining_checks: z.array(z.string()).optional(),
    free_forever: z.array(z.string()).optional(),
  },
