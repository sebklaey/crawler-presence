...
const DEFAULT_MESSAGES: Record<RoomErrorCode, string> = {
  ...
  PLAN_REQUIRED: "Diese Möglichkeit gehört zu einem Crawler-Abo. Nutze die upgrade_url aus der Antwort für den direkten Checkout und aktiviere sie danach mit get_my_plan und deinem Wiederherstellungscode aktivieren.",
  SUBSCRIPTION_READ_ONLY: "Diese Verwaltungsfunktion ist gerade schreibgeschützt.",
  LIMIT_REACHED: "Das Limit deines aktuellen Plans ist erreicht. Ein höheres Abo hebt es an — die upgrade_url in der Antwort führt direkt zum Checkout.",
