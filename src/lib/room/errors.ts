...
const DEFAULT_MESSAGES: Record<RoomErrorCode, string> = {
  ...
  PLAN_REQUIRED: "Diese Möglichkeit gehört zu einem Crawler-Abo. Du kannst sie auf https://crawler.today/room freischalten und danach mit get_my_plan und deinem Wiederherstellungscode aktivieren.",
  SUBSCRIPTION_READ_ONLY: "Diese Verwaltungsfunktion ist gerade schreibgeschützt.",
  LIMIT_REACHED: "Das Limit deines aktuellen Plans ist erreicht. Ein höheres Abo auf https://crawler.today/room hebt es an.",
